...
# This is a threaded class that allows one to launch at function then retrieve a value
...
# simple  function that takes time used for an example of how the spinner
# works.
def long_operation():
    for i in range(120):
        time.sleep(.1)
...
def roundDownTo10(x):
    value = int(math.floor(x / 10.0)) * 10
    if value < 10:
        value = 10
    return value
...
if __name__ == '__main__':
    print(banner("Start of Examples"))

    # usage example of spinner
    print("Example of spinner")
    spinner_thread = SpinnerThread()
    spinner_thread.start()
    long_operation()
    spinner_thread.stop()
    
    # usage exmaple of clear screen
    clear()
    print("That was an example of clearing the screen.")
    
    # this shows how a both the spinner thread and a threaded function 
    # that returns a value works together. 
    spinner_thread = SpinnerThread()
    spinner_thread.start()
